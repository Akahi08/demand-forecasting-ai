...
Select whether the product is currently on promotion.
Enter the relevant date and calendar information.
Enter historical sales lag values.
Enter rolling sales statistics.
Enter price-change information.
Enter historical promotion information.
Click Predict Sales.
